...
var Main = function () {
    ...
    var runModuleTools = function () {
        $('.panel-tools .panel-expand').off('click');
        ...
        $('.panel-tools .panel-close').off('click');
        $('.panel-tools .panel-close').bind('click', function (e) {
            $(this).parents(".panel").remove();
            e.preventDefault();
        });
        $('.panel-tools .panel-refresh').off("click");
        $('.panel-tools .panel-refresh').bind('click', function (e) {
            ...
            el.block({
                ...
                message: '<img src="'+tar.appPath+'assets/images/loading.gif" /> Just a moment...',
                css: {
                    border: 'none',
                    color: '#333',
                    background: 'none'
        ...
        $('.panel-tools .panel-collapse').off("click");
