...
namespace Tar.Logging
{
    public class Logger : ILogger
    {
        ...
        public ILogScope CreateScope(string scope)
        {
            return new LogScope(scope, this);
        }
        ...
        public virtual ILogger Write(Type source, LogLevel level, object message)
        {
            ...
            className = string.Format("{0}.{1},{2}", source.Namespace, source.Name, source.Assembly.GetName().Name);
        ...
        {
            Repository.WriteToLog(parameter);
            return this;
        }
