...
namespace Tar.Core.LoggingOld2
{
   public static class Extensions
   {
       ...
       private static EnvironmentObjectContainer _container = new EnvironmentObjectContainer();
       private const string IpAddressKey = "Logger.IpAddressKey";

       public static void IpAddress(this object source, string ipAddress)
       {
           _container.Set(IpAddressKey, ipAddress);
       }
       ...
       public static string IpAddress(this object source)
       {
           ...
           if(_container.Get(IpAddressKey)!=null)
           {
               return _container.Get(IpAddressKey) as string;
           }
