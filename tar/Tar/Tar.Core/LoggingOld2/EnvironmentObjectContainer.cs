...
{
    class EnvironmentObjectContainer : IObjectContainer
    {
        private static readonly object LockObject = new object();

        private static readonly Dictionary<object, Dictionary<object, object>> Objects =
            ...
            get
            {
                ...
                if(System.Web.HttpContext.Current.Session == null)
                {
                    return System.Web.HttpContext.Current.Items["EnvironmentObjectContainer.EnvironmentKey"] ??
                           (System.Web.HttpContext.Current.Items["EnvironmentObjectContainer.EnvironmentKey"] =
                            Guid.NewGuid());
                }
